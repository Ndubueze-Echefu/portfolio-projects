...
type = ChangeState
triggerall = (roundstate = 2) && (var(59) != 0)
trigger1 = (stateno = 610) && (power > 600) && movecontact && (random = [0,100])
value = 660
...
triggerall = (Ctrl) && (Statetype = S) && (random = [0,75])
...
triggerall = stateno < 3000
triggerall = (Ctrl) && (Statetype = S) && (random = [0,500])
trigger1 = (p2bodydist X <= 135) && (prevstateno != 5120) && (p2movetype != H) && (statetype != A)
value = 1000
...
triggerall = stateno < 3000
triggerall = (Ctrl) && (Statetype = S) && (random = [0,500])
trigger1 = (p2bodydist X <= 140) && (prevstateno != 5120) && (p2movetype != H) && (statetype != A)
